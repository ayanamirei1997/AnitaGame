...
{
    public static string saveDir = Application.dataPath + "/Anita/Sources/ThirdParty/ToLua/Source/Generate/";
    public static string toluaBaseType = Application.dataPath + "/Anita/Sources/ThirdParty/ToLua/BaseType/";
    public static string baseLuaDir = Application.dataPath + "/Anita/Lua/";
    public static string injectionFilesPath = Application.dataPath + "/Anita/Sources/ThirdParty/ToLua/Injection/";
    ...
    public static BindType[] customTypeList =>
        _customTypeList.Concat(
            AppDomain.CurrentDomain.GetAssemblies()
                ...
                .Where(t => t.GetCustomAttribute<Anita.ExportCustomType>() != null)
