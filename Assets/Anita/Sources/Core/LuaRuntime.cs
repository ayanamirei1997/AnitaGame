...
namespace Anita
{
    ...
    public class LuaRuntime : MonoBehaviour
    {
        ...
        /// </summary>
        /// <remarks>
        /// This method should be called before every Anita related work happens. The begining of the Start or Awake
        ...
        /// </summary>
        /// <remarks>
        /// The object will be assigned as an entry of the global variable <code>__Anita</code>, with the given name,
        /// which can be accessed from lua scripts by <code>__Anita[name]</code>.
        /// </remarks>
                ...
                lock (Lock)
                {
                    if (_instance == null)
                    {
                        ...
                        if (_instance == null)
                        {
                            ...
                            // Debug.LogFormat("Anita: [Singleton] An instance of {0} " +
                        ...
                        {
                            // Debug.LogFormat("Anita: [Singleton] Using instance already created: {0}",
