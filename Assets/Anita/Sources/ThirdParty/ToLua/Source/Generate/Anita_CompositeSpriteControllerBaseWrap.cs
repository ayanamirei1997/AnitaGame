...
public class Anita_CompositeSpriteControllerBaseWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(Anita.CompositeSpriteControllerBase), typeof(UnityEngine.MonoBehaviour));
	...
	static int PreloadPose(IntPtr L)
	{
		try
		{
			...
			Anita.CompositeSpriteControllerBase obj = (Anita.CompositeSpriteControllerBase)ToLua.CheckObject<Anita.CompositeSpriteControllerBase>(L, 1);
	...
	static int SetPose(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: Anita.CompositeSpriteControllerBase.SetPose");
			}
		}
		catch (Exception e)
		{
	...
	static int SetImage(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: Anita.CompositeSpriteControllerBase.SetImage");
			}
		}
		catch (Exception e)
		{
	...
	static int ClearImage(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: Anita.CompositeSpriteControllerBase.ClearImage");
			}
		}
		catch (Exception e)
		{
	...
	static int get_imageFolder(IntPtr L)
	{
		...
		try
		{
			...
			Anita.CompositeSpriteControllerBase obj = (Anita.CompositeSpriteControllerBase)o;
	...
	static int get_characterTextureMerger(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			Anita.CompositeSpriteControllerBase obj = (Anita.CompositeSpriteControllerBase)o;
			Anita.SpriteMerger ret = obj.characterTextureMerger;
			ToLua.Push(L, ret);
			return 1;
		}
		catch(Exception e)
	...
	static int get_textureChanger(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			Anita.CompositeSpriteControllerBase obj = (Anita.CompositeSpriteControllerBase)o;
			Anita.OverlayTextureChangerBase ret = obj.textureChanger;
			ToLua.Push(L, ret);
			return 1;
		}
		catch(Exception e)
	...
	static int set_characterTextureMerger(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			Anita.CompositeSpriteControllerBase obj = (Anita.CompositeSpriteControllerBase)o;
			Anita.SpriteMerger arg0 = (Anita.SpriteMerger)ToLua.CheckObject<Anita.SpriteMerger>(L, 2);
