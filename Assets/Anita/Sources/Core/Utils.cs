...
namespace Anita
{
    public static class Utils
    {
        ...
        public static void RuntimeAssert(this MonoBehaviour mb, bool conditionToBeTrue, string msg)
        {
            ...
            {
                throw new Exception($"Anita - {mb.name}: {msg}");
            }
        }
        ...
        private static GameObject FindAnitaGameControllerObject()
        {
            var gameControllerObject = GameObject.FindWithTag("AnitaGameController");
            if (gameControllerObject == null)
            {
                throw new InvalidAccessException(
                    "Anita: Cannot find AnitaGameController by tag. Maybe you should put AnitaCreator prefab in your scene.");
            }

            return gameControllerObject;
        }

        public static GameController FindAnitaGameController()
        {
            var go = FindAnitaGameControllerObject();
            if (go == null)
            {
                return null;
            }
            ...
            {
                throw new InvalidAccessException(
                    "Anita: No GameController component in AnitaGameController game object.");
            }
        ...
        {
            var gameController = FindAnitaGameController();
