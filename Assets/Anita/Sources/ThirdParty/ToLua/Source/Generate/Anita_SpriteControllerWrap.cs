...
public class Anita_SpriteControllerWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(Anita.SpriteController), typeof(UnityEngine.MonoBehaviour));
	...
	static int SetImage(IntPtr L)
	{
		try
		{
			...
			if (count == 2)
			{
				Anita.SpriteController obj = (Anita.SpriteController)ToLua.CheckObject<Anita.SpriteController>(L, 1);
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: Anita.SpriteController.SetImage");
			}
		}
		catch (Exception e)
		{
	...
	static int ClearImage(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: Anita.SpriteController.ClearImage");
			}
		}
		catch (Exception e)
		{
	...
	static int get_luaGlobalName(IntPtr L)
	{
		...
		try
		{
			...
			Anita.SpriteController obj = (Anita.SpriteController)o;
