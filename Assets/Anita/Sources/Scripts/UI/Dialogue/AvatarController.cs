...
namespace Anita
{
    ...
    public class AvatarController : CompositeSpriteControllerBase
    {
        ...
        private bool CheckCharacterName(string imageName)
        {
            ...
            {
                Debug.LogWarning($"Anita: Set avatar {imageName} with empty characterName");
                return false;
            }

            if (!nameToConfig.ContainsKey(characterName))
            {
                Debug.LogWarning($"Anita: Set avatar {imageName} with unknown characterName {characterName}");
                return false;
            }
        ...
        public CharacterController GetCharacterController()
        {
            ...
            {
                Debug.LogWarning($"Anita: GetCharacterController with unknown characterName {characterName}");
                return null;
            }
        }
