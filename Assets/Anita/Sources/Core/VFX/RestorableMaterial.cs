    ...
    public class RestorableMaterial : Material
    {
        ...
        private static void Init(string shaderName)
        {
            ...
            Debug.LogWarningFormat(
                "Anita: Shader {0} is not in shader info database. The material will not be restored correctly.",
                shaderName);
        }
        ...
        {
            Debug.LogWarningFormat(
                "Anita: Setting a texture to {0}:{1} without a path to texture. The material will not be restored correctly. Please use SetTexturePath() instead.",
