...
public class Nova_AutoVoiceWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(Nova.AutoVoice), typeof(UnityEngine.MonoBehaviour));
	...
	static int GetCharacterController(IntPtr L)
	{
		try
		{
			...
			Nova.AutoVoice obj = (Nova.AutoVoice)ToLua.CheckObject<Nova.AutoVoice>(L, 1);
			string arg0 = ToLua.CheckString(L, 2);
			Nova.CharacterController o = obj.GetCharacterController(arg0);
			ToLua.Push(L, o);
			return 1;
		}
		catch (Exception e)
	...
	static int get_luaName(IntPtr L)
	{
		...
		try
		{
			...
			Nova.AutoVoice obj = (Nova.AutoVoice)o;
	...
	static int get_autoVoiceConfigs(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			Nova.AutoVoice obj = (Nova.AutoVoice)o;
			System.Collections.Generic.List<Nova.AutoVoiceConfig> ret = obj.autoVoiceConfigs;
	...
	static int set_autoVoiceConfigs(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			Nova.AutoVoice obj = (Nova.AutoVoice)o;
			System.Collections.Generic.List<Nova.AutoVoiceConfig> arg0 = (System.Collections.Generic.List<Nova.AutoVoiceConfig>)ToLua.CheckObject(L, 2, typeof(System.Collections.Generic.List<Nova.AutoVoiceConfig>));
