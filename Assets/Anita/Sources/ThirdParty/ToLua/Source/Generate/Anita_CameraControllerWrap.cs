...
public class Anita_CameraControllerWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(Anita.CameraController), typeof(UnityEngine.MonoBehaviour));
	...
	static int GetComponent(IntPtr L)
	{
		try
		{
			...
			{
				Anita.CameraController obj = (Anita.CameraController)ToLua.CheckObject<Anita.CameraController>(L, 1);
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: Anita.CameraController.GetComponent");
			}
		}
		catch (Exception e)
		{
	...
	static int get_luaGlobalName(IntPtr L)
	{
		...
		try
		{
			...
			Anita.CameraController obj = (Anita.CameraController)o;
