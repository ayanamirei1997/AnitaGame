...
public class Nova_CheckpointHelperWrap
{
	...
	{
		L.BeginClass(typeof(Nova.CheckpointHelper), typeof(UnityEngine.MonoBehaviour));
	...
	static int GetGlobalVariable(IntPtr L)
	{
		try
		{
			...
			Nova.VariableEntry o = obj.GetGlobalVariable(arg0);
	...
	static int get_WarningStepNumFromLastCheckpoint(IntPtr L)
	{
		try
		{
			LuaDLL.lua_pushinteger(L, Nova.CheckpointHelper.WarningStepNumFromLastCheckpoint);
			return 1;
		}
		catch (Exception e)
		{
