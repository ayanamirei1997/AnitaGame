...
namespace Anita
{
        ...
        IDialogueBoxController, IRestorable
    {
        ...
        private void JumpChapter(int offset)
        {
            ...
            {
                Debug.LogWarning($"Anita: No chapter index {targetChapterIndex}");
            }
        }
        ...
        {
            return Mathf.Max(
                AnitaAnimation.GetTotalTimeRemaining(AnimationType.PerDialogue | AnimationType.Text) + offset,
        ...
        private float GetDialogueTimeAuto()
        {
            return Mathf.Max(
                ...
                AnitaAnimation.GetTotalTimeRemaining(AnimationType.Text) / perCharacterFadeInDuration * autoDelay * 0.1f
            );
        }
        ...
        [SerializeField] private AnitaAnimation textAnimation;
