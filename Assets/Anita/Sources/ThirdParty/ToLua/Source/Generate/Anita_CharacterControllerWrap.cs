...
public class Anita_CharacterControllerWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(Anita.CharacterController), typeof(Anita.CompositeSpriteControllerBase));
	...
	static int Say(IntPtr L)
	{
		try
		{
			...
			Anita.CharacterController obj = (Anita.CharacterController)ToLua.CheckObject<Anita.CharacterController>(L, 1);
	...
	static int ReplayVoice(IntPtr L)
	{
		try
		{
			...
			if (count == 1)
			{
				System.Collections.Generic.IReadOnlyDictionary<string,Anita.VoiceEntry> arg0 = (System.Collections.Generic.IReadOnlyDictionary<string,Anita.VoiceEntry>)ToLua.CheckObject<System.Collections.Generic.IReadOnlyDictionary<string,Anita.VoiceEntry>>(L, 1);
				Anita.CharacterController.ReplayVoice(arg0);
				return 0;
			}
			else if (count == 2)
			{
				...
				Anita.CharacterController.ReplayVoice(arg0, arg1);
				return 0;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: Anita.CharacterController.ReplayVoice");
			}
		}
		catch (Exception e)
		{
	...
	static int StopVoiceAll(IntPtr L)
	{
		try
		{
			...
			Anita.CharacterController.StopVoiceAll();
			return 0;
		}
		catch (Exception e)
		{
	...
	static int get_luaGlobalName(IntPtr L)
	{
		...
		try
		{
			...
			Anita.CharacterController obj = (Anita.CharacterController)o;
	...
	static int get_MaxVoiceDurationOfNextDialogue(IntPtr L)
	{
		try
		{
			LuaDLL.lua_pushnumber(L, Anita.CharacterController.MaxVoiceDurationOfNextDialogue);
			return 1;
		}
		catch (Exception e)
		{
