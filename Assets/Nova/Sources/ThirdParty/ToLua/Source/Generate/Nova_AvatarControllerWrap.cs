...
public class Nova_AvatarControllerWrap
{
	...
	static int GetCharacterController(IntPtr L)
	{
		try
		{
			...
			Nova.AvatarController obj = (Nova.AvatarController)ToLua.CheckObject<Nova.AvatarController>(L, 1);
			Nova.CharacterController o = obj.GetCharacterController();
			ToLua.Push(L, o);
			return 1;
		}
		catch (Exception e)
	...
	static int get_avatarConfigs(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			Nova.AvatarController obj = (Nova.AvatarController)o;
			System.Collections.Generic.List<Nova.AvatarConfig> ret = obj.avatarConfigs;
	...
	static int set_avatarConfigs(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			Nova.AvatarController obj = (Nova.AvatarController)o;
			System.Collections.Generic.List<Nova.AvatarConfig> arg0 = (System.Collections.Generic.List<Nova.AvatarConfig>)ToLua.CheckObject(L, 2, typeof(System.Collections.Generic.List<Nova.AvatarConfig>));
