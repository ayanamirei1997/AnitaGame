...
{
    public static string saveDir = Application.dataPath + "/AnitaAVG/Scripts/3rdParty/ToLua/Source/Generate/";
    public static string toluaBaseType = Application.dataPath + "/AnitaAVG/Scripts/3rdParty/ToLua/BaseType/";
    public static string baseLuaDir = Application.dataPath + "/AnitaAVG/Lua/";
    public static string injectionFilesPath = Application.dataPath + "/AnitaAVG/Scripts/3rdParty/ToLua/Injection/";
