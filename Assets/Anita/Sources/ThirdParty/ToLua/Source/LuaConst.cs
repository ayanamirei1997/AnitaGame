...
{
    public static string luaDir = Application.dataPath + "/Anita/Lua"; //lua逻辑代码目录
    public static string toluaDir = Application.dataPath + "/Anita/Sources/ThirdParty/ToLua/ToLua/Lua"; //tolua lua文件目录
