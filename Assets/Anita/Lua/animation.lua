...
RELATIVE = Anita.UseRelativeValue.Yes
...
_move = wrap_vec3_property(Anita.PositionAnimationProperty)
_rotate = wrap_vec3_property(Anita.RotationAnimationProperty)
_scale = wrap_vec3_property(Anita.ScaleAnimationProperty)
...
function _action(t)
    ...
    return Anita.ActionAnimationProperty(action)
end
...
function _change_mat_float(t)
    ...
    if from then
       return Anita.MaterialFloatAnimationProperty(mat, name, from, to)
    else
       return Anita.MaterialFloatAnimationProperty(mat, name, to)
    end
end
