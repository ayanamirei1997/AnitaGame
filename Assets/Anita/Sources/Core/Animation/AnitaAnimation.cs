...
namespace Anita
{
    ...
    [ExportCustomType]
    public class AnitaAnimation : MonoBehaviour
    {
        public AnimationType type = AnimationType.PerDialogue;

        #region Static members

        private static readonly List<AnitaAnimation> Animations = new List<AnitaAnimation>();
        ...
        private static void AddAnimation(AnitaAnimation animation)
        {
            // Debug.LogFormat("AddAnimation {0}", Utils.GetPath(animation));
            Animations.Add(animation);
        }

        private static void RemoveAnimation(AnitaAnimation animation)
        {
