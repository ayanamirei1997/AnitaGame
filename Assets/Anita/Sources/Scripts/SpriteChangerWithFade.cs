...
namespace Anita
{
    public class SpriteChangerWithFade : MonoBehaviour
    {
        ...
        private Image image;
        private AnitaAnimation anitaAnimation;
        ...
        private void Awake()
        {
            ...
            anitaAnimation = GameObject.FindWithTag("AnitaAnimation").transform.Find("PerDialogue")
                .GetComponent<AnitaAnimation>();
        ...
        private void SetSpriteRenderer(Sprite value, bool overlay)
        {
            ...
            if (spriteRenderer.sprite != null)
            {
                ...
                anitaAnimation.Do(new OpacityAnimationProperty(ghostSpriteRenderer, color.a, colorTo.a), fadeDuration)
            ...
            if (value != null)
            {
                ...
                if (!overlay)
                {
                    ...
                    if (needFadeInDelay)
                    {
                        anitaAnimation.Do(null, fadeInDelay)
                            .Then(new OpacityAnimationProperty(spriteRenderer, colorTo.a, color.a), fadeDuration);
                    }
                    else
                    {
                        anitaAnimation.Do(new OpacityAnimationProperty(spriteRenderer, colorTo.a, color.a),
                            fadeDuration);
                    }
                }
            }
        ...
        private void SetImage(Sprite value, bool overlay)
        {
            ...
            if (image.sprite != null)
            {
                ...
                ghost.SetActive(true);
                anitaAnimation.Do(new OpacityAnimationProperty(ghostImage, color.a, colorTo.a), fadeDuration)
                    .Then(new ActionAnimationProperty(() => ghost.SetActive(false)));
            }
            ...
            if (value != null)
            {
                ...
                if (!overlay)
                {
                    ...
                    {
                        anitaAnimation.Do(new OpacityAnimationProperty(image, colorTo.a, color.a), fadeDuration);
                    }
                }
            }
            else
