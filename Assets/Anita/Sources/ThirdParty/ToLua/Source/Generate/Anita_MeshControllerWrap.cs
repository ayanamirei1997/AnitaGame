...
public class Anita_MeshControllerWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(Anita.MeshController), typeof(UnityEngine.MonoBehaviour));
	...
	static int GetRestoreData(IntPtr L)
	{
		try
		{
			...
			Anita.MeshController obj = (Anita.MeshController)ToLua.CheckObject<Anita.MeshController>(L, 1);
	...
	static int get_luaGlobalName(IntPtr L)
	{
		...
		try
		{
			...
			Anita.MeshController obj = (Anita.MeshController)o;
