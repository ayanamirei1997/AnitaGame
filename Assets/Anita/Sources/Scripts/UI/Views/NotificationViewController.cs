...
namespace Anita
{
    public class NotificationViewController : ViewControllerBase
    {
        ...
        private IEnumerator NotificationFadeOut(GameObject notification, float timeout, Action onFinish)
        {
            ...
            // TODO: there is a AnitaAnimation in NotificationItem, and this Action is in that AnitaAnimation.
            // Destroy(notification) will call AnitaAnimation.OnDisable() -> AnitaAnimation.Stop() -> this Action.
