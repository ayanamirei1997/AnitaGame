...
public class Anita_BranchImageInformationWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(Anita.BranchImageInformation), typeof(System.Object));
		L.RegFunction("New", _CreateAnita_BranchImageInformation);
	...
	static int _CreateAnita_BranchImageInformation(IntPtr L)
	{
		try
		{
			...
			if (count == 4)
			{
				...
				Anita.BranchImageInformation obj = new Anita.BranchImageInformation(arg0, arg1, arg2, arg3);
				ToLua.PushObject(L, obj);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: Anita.BranchImageInformation.New");
			}
		}
		catch (Exception e)
		{
	...
	static int get_name(IntPtr L)
	{
		...
		try
		{
			...
			Anita.BranchImageInformation obj = (Anita.BranchImageInformation)o;
			string ret = obj.name;
