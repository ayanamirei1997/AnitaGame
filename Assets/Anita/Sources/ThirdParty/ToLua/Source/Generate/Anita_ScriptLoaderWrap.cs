...
public class Anita_ScriptLoaderWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(Anita.ScriptLoader), typeof(System.Object));
		...
		L.RegFunction("New", _CreateAnita_ScriptLoader);
	...
	static int _CreateAnita_ScriptLoader(IntPtr L)
	{
		try
		{
			...
			if (count == 0)
			{
				Anita.ScriptLoader obj = new Anita.ScriptLoader();
				ToLua.PushObject(L, obj);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: Anita.ScriptLoader.New");
			}
		}
		catch (Exception e)
		{
	...
	static int Init(IntPtr L)
	{
		try
		{
			...
			Anita.ScriptLoader obj = (Anita.ScriptLoader)ToLua.CheckObject<Anita.ScriptLoader>(L, 1);
	...
	static int GetFlowChartTree(IntPtr L)
	{
		try
		{
			...
			Anita.ScriptLoader obj = (Anita.ScriptLoader)ToLua.CheckObject<Anita.ScriptLoader>(L, 1);
			Anita.FlowChartTree o = obj.GetFlowChartTree();
	...
	static int RegisterBranch(IntPtr L)
	{
		try
		{
			...
			Anita.BranchImageInformation arg3 = (Anita.BranchImageInformation)ToLua.CheckObject<Anita.BranchImageInformation>(L, 5);
			Anita.BranchMode arg4 = (Anita.BranchMode)ToLua.CheckObject(L, 6, typeof(Anita.BranchMode));
	...
	static int get_stateLocale(IntPtr L)
	{
		...
		try
		{
			...
			Anita.ScriptLoader obj = (Anita.ScriptLoader)o;
